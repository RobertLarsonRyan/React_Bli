	...
	if ((press >= 4) && (document.getElementById("q" + i).value.toUpperCase() != ans[i])) {
        ...
        document.getElementById("q" + i).value = ans[i];
		 ...
		 document.getElementById("img" + i).src = "../../../../../images/icons/tick.gif";
	      document.getElementById("info" + i).src = "../../../../../images/icons/info_icon.gif";
		  document.getElementById("info" + i).style.display = "inherit";
...
//function to hide and show the audio boxes
function showObjectAudio(number){
  var number = number;
  yourAns[number]= document.getElementById("q" + number).value;
  
  
  yourAns[number] =yourAns[number].toUpperCase();
  
  if(yourAns[number] == ans[number]){
  
  document.getElementById("p" + number).style.visibility = "visible";
   
   if (document.createElement("input").webkitSpeech==undefined && !document.getElementById('newSpan' + number)) {
