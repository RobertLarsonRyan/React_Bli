...
function Press(ans,yourAns) {
	...
	document.getElementById("audio" + i).src = "../../../../../images/icons/audio_icon111.gif";
	document.getElementById("audio" + i).style.display = "inherit";
...
var Qnumber = 0;
		...
		Qnumber = number;
		  ...
		  recognition.start();
			        ...
			        recognition.onerror = function (event) { alert("This speaking test is currently not available. Sorry.");
		}
